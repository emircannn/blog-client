...
const Logo = () => {
    return ( 
        ...
        <Link href='/'>
            <Image alt="Zincirkıran" title="Zincirkıran" src='/images/logolight.png' fill quality={100} className="object-contain"/>
        </Link>
        ...
        <Link href='/'>
            <Image alt="Zincirkıran" title="Zincirkıran" src='/images/logodark.png' fill quality={100} className="object-contain"/>
        </Link>
        {/* <span className="text-2xl font-semibold">Logo</span> */}
        </div>
        </>
