    ...
    <div className="px-2 w-full">
        <div className="w-full aspect-[1/1.3] rounded-xl bg-white dark:bg-darkerColor flex flex-col overflow-hidden">
            <div className="w-full h-1/2 relative">
                ...
                <div className="w-full absolute -bottom-7 md:-bottom-10 left-0 flex items-center justify-center">
            ...
            <div className="w-full h-1/2 pt-10 md:pt-14 px-4 pb-4 flex flex-col gap-2 text-center">
